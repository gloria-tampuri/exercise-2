...
removeParagraph.addEventListener('click', firstFunction)
backgroundChange.addEventListener('click', secondFunction)
...
const thirdParagraph = document.getElementById('thirdPara');
